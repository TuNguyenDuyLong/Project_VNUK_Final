...
const TimeTable = () => {
    ...
    const handleSemesterSearch = () => {
        ...
        const apiUrl = `${config.API_BASE_URL}/api/TimeTable/getStudentTimeTable?SemestersID=${selectedSemester}`;
    ...
    const handleWeekSearch = () => {
        ...
        const apiUrl = `${config.API_BASE_URL}/api/TimeTable/GetStudentTimeTableFoWeek?week=${week}&semesterId=${selectedSemester}`;
        console.log(`API URL gọi: ${apiUrl}`);
    ...
    return (
        <div className="timetable-container">
            ...
            <table className="period-time-table">
                ...
                <tbody>
                    <tr><td>Tiết 1</td><td>7:00 AM - 7:45 AM</td></tr>
                    <tr><td>Tiết 2</td><td>7:45 AM - 8:30 AM</td></tr>
                    <tr><td>Tiết 3</td><td>8:30 AM - 9:15 AM</td></tr>
                    <tr><td>Tiết 4</td><td>9:15 AM - 10:00 AM</td></tr>
                    <tr><td>Tiết 5</td><td>10:00 AM - 10:45 AM</td></tr>
                    <tr><td>Tiết 6</td><td>10:45 AM - 11:30 AM</td></tr>
                    <tr><td>Tiết 7</td><td>11:30 AM - 12:15 PM</td></tr>
