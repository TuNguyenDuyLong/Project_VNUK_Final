...
import './Tea_CreateNoteti_session.scss';
import { Link } from 'react-router-dom';
import config from '../../../config';

const Tea_CreateNoteti_session = () => {
    ...
    const [title, setTitle] = useState(null); // Lưu lỗi (nếu có)
    ...
    const handleSubmit = async (e) => {
        ...
        if (!selectedSemester || !selectedCourse || !selectedClass || !week || !reason || !title) {
        ...
        try {
            const response = await fetch(`${config.API_BASE_URL}/api/ClassNotification/CreateClassNoticification`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
        ...
        <div className="CreateNotification">
            <div className="grid__column-2-3">
                <div className="View_Created_Notetication">
                    <p className="CreateNotification_title">TẠO THÔNG BÁO MÔN HỌC</p>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <label htmlFor="note">Tiêu đề thông báo:</label>
                            <textarea
                                id="title"
                                value={title}
                        ...
                        <div className="form-group">
                            <label htmlFor="note">Nội dung thông báo:</label>
                            <textarea
                                id="note"
                                value={reason}
...
export default Tea_CreateNoteti_session;
